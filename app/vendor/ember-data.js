...
(function(global) {
    ...
    define("activemodel-adapter/lib/main", ["./system", "exports"],
    ...
    define("activemodel-adapter/lib/setup-container", ["../../ember-data/lib/system/container_proxy", "./system/active_model_serializer", "./system/active_model_adapter", "exports"],
    ...
    */
      ...
      */
            ...
            function updatePayloadWithEmbeddedBelongsTo(serializer, store, primaryType, relationship, payload, partial) {
                ...
                if (!attrs || !(hasDeserializeRecordsOption(attrs, Ember.String.camelize(primaryType)) ||
    ...
    */
    ...
    define("ember-data/lib/ember-initializer", ["./setup-container"],
    ...
    */
    ...
    define("ember-data/lib/initializers/data_adapter", ["../system/debug/debug_adapter", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
    ...
    */
    ...
    define("ember-data/lib/initializers/store", ["../serializers", "../adapters", "../system/container_proxy", "../system/store", "exports"],
    ...
    */
    ...
    define("ember-data/lib/initializers/store_injections", ["exports"],
        function(__exports__) {
            "use strict";
            /**
      Configures a container with injections on Ember applications
    ...
    */
    ...
    define("ember-data/lib/initializers/transforms", ["../transforms", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
    ...
    */
    ...
    define("ember-data/lib/serializers/json_serializer", ["../system/changes", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
    ...
    */
    ...
    define("ember-data/lib/serializers/rest_serializer", ["./json_serializer", "ember-inflector/lib/system/string", "exports"],
        function(__dependency1__, __dependency2__, __exports__) {
            "use strict";
            /**
      @module ember-data
    ...
    */
    ...
    define("ember-data/lib/setup-container", ["./initializers/store", "./initializers/transforms", "./initializers/store_injections", "./initializers/data_adapter", "../../../activemodel-adapter/lib/setup-container", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __dependency5__, __exports__) {
            "use strict";
    ...
    */
    ...
    define("ember-data/lib/system/changes", ["./changes/relationship_change", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
            /**
      @module ember-data
    ...
    */
    ...
    define("ember-data/lib/system/model/model", ["./states", "./errors", "../store", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
            "use strict";
    ...
    */
      ...
      */
                toJSON: function(options) {
                    if (!JSONSerializer) {
                        JSONSerializer = requireModule("ember-data/lib/serializers/json_serializer")["default"];
                    }
    ...
    */
    ...
    define("ember-data/lib/system/relationship-meta", ["../../../ember-inflector/lib/system", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
            var singularize = __dependency1__.singularize;
    ...
    */
    ...
    define("ember-data/lib/system/relationships/belongs_to", ["../model", "../store", "../changes", "../relationship-meta", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
            "use strict";
            var get = Ember.get,
                set = Ember.set,
    ...
    */
      ...
      */
                belongsToWillChange: Ember.beforeObserver(function(record, key) {
                    if (get(record, 'isLoaded')) {
                        ...
                        if (oldParent) {
                            var store = get(record, 'store'),
                                change = RelationshipChange.createChange(record, oldParent, store, {
                                    key: key,
                                    kind: "belongsTo",
                                    changeType: "remove"
                                });
      ...
      */
                belongsToDidChange: Ember.immediateObserver(function(record, key) {
                    if (get(record, 'isLoaded')) {
                        ...
                        if (newParent) {
                            var store = get(record, 'store'),
                                change = RelationshipChange.createChange(record, newParent, store, {
                                    key: key,
                                    kind: "belongsTo",
                                    changeType: "add"
                                });
    ...
    define("ember-data/lib/system/relationships/ext", ["../../../../ember-inflector/lib/system", "../relationship-meta", "../model"],
    ...
    */
    ...
    define("ember-data/lib/system/relationships/has_many", ["../store", "../relationship-meta", "exports"],
        function(__dependency1__, __dependency2__, __exports__) {
            "use strict";
            /**
      @module ember-data
    ...
    */
    ...
    define("ember-data/lib/system/store", ["./adapter", "ember-inflector/lib/system/string", "exports"],
        function(__dependency1__, __dependency2__, __exports__) {
            "use strict";
            /*globals Ember*/
            /*jshint eqnull:true*/
